...
function UnifiedJointProbability({ selectedLocation, locationName }) {
  ...
  const isUnavailable = Object.keys(UNAVAILABLE_DISTRIBUTIONS).includes(selectedDistribution);
      ...
      {selectedLocation ? (
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: '14px' }}>
            Click on the map to select a location and view joint probability distributions
          </p>
        </div>
      )}
    </div>
...
export default UnifiedJointProbability;